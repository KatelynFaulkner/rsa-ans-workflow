...
Input A is provided by the user and can be downloaded from https://posa.sanbi.org/sanbi/Explore. The user saves the file in the `inputs/` subfolder.
...
Input C is provided by the user, who saves the files in the `inputs/` subfolder. 
