...
The final output is saved in the `processed/` folder as a csv named 'Taxon_names_standardised.csv'. The final output contains 17 columns.
...
misap: taxon name was misapplied in terms of its concept to a taxon
