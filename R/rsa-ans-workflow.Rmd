...
2. In Step 2b, information on the format of the taxon names must be manually entered into the script. There are two accepted options: scientific or canonical.
...
In the quotation marks in the chunk of code below, type in the format of the taxon names: either 'canonical' or 'scientific'

```{r}
UserNameType<-"" # In the quotation marks, type in either 'canonical' or 'scientific'
```
