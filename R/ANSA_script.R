...
## Step 2: Install and load remote package R cran, and intall packages from GitHub (those not on the R cran)
...
## Step 3: Load list of names for standardisation

NamesDat<-read.csv("data\\Inputs\\OriginalNames.csv")

## Step 4: Load dataset from BODATSA

BODATSA<-read.csv("data\\Inputs\\BODATSA.csv")

# Preparation of list of names for standardisation

## Step 5: Provision of information, basic data exploration and cleaning for list of species requiring standardisation
...
## Step 6: Get canonical name and higher taxonomic information for the taxa from GBIF
...
## Step 7: Separate dataset into plants and other organisms
...
# Preparation of data from BODATSA

## Step 8: Provision of information, basic data exploration and cleaning for list of species requiring standardisation
...
## Step 9: Join data in seperate columns to get canonical name and scientific names
...
## Step 10: Check names non-plants against the GBIF backbone 
...
write.csv(GBIFRaw, "data//Outputs//Intermediate//GBIF.csv")

## Step 11: Look at the results and flag issues
...
write.csv(GBIFMatch, "data\\Outputs\\Intermediate\\NonPlantOrganisms_GBIF_standardisation.csv", row.names = FALSE)

# Taxonomic standardisation for plant taxa using BODATSA backbone

## Step 13: Match plant names with those in BODATSA
...
BODATSARaw<-BODATSAMatch

write.csv(BODATSARaw, "data//Outputs//Intermediate//BODATSA.csv")
...
## Step 14: Look at the results and flag issues
...
write.csv(BODATSAMatch, "data\\Outputs\\Intermediate\\Plants_BODATSA_standardisation.csv", row.names = FALSE)

# Taxonomic standardisation for plant taxa using WCVP backbone

## Step 15: Match plant names unrecognised by BODATSA with those in WCVP
...
write.csv(WCVPRaw, "data//Outputs//Intermediate//WCVP.csv")
...
## Step 16: Look at the results and flag issues
...
write.csv(WCVPMatch, "data\\Outputs\\Intermediate\\Plants_WCVP_standardisation.csv", row.names = FALSE)

# Merge results into one output file

## Step 18: Create overall output dataset
